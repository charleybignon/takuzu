...
package tests_TAD_Pile is
   ...
   function test_Exception_Pile_Videc return Boolean;
   function test_Exception_Indice_Invalide return Boolean;
   ...
   les_Tests : constant array (Positive range <>) of Test_Unitaire :=
     ((test_P1'Access, To_Unbounded_String("echec de la propriété 1")),
      ...
      (test_Exception_Pile_Videc'Access, To_Unbounded_String("echec de la propriété Exception Pile Vide c")),
      (test_Exception_Indice_Invalide'Access, To_Unbounded_String("echec de la propriété Exception Indice Invalide")));

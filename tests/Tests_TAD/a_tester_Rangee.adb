...
package body A_Tester_Rangee is
  ...
  function Test_Rangee_P23b return Boolean is
   ...
   -- Fonction "="
   -- Avec R1 = R2
   function Test_Rangee_P27 return Boolean is
      R1, R2 : Type_Rangee;
   begin
      R1 := ConstruireRangee( 8 );
      R2 := ConstruireRangee( 8 );
      R1 := AjouterChiffre( R1, 1, UN );
      R2 := AjouterChiffre( R2, 1, UN );
      for  i in 2..Taille(R1) loop
         R1 := AjouterChiffre( R1, i, ZERO );
         R2 := AjouterChiffre( R2, i, ZERO );
      end loop;
      return R1 = R2;
   end Test_Rangee_P27;
   ...
   -- Fonction "="
   -- Avec R1 = R2 et un ou plusieurs chiffre INCONNU
   function Test_Rangee_P29 return Boolean is
      R1, R2 : Type_Rangee;
   begin
      R1 := ConstruireRangee( 8 );
      R2 := ConstruireRangee( 8 );
      for  i in 3..Taille(R1) loop
         R1 := AjouterChiffre( R1, i, ZERO );
         R2 := AjouterChiffre( R2, i, ZERO );
      end loop;
      return R1 = R2;
   ...
   -- Fonction "="
   -- Avec R1 /= R2 et un ou plusieurs chiffre INCONNU
   function Test_Rangee_P30 return Boolean is
      R1, R2 : Type_Rangee;
   begin
      R1 := ConstruireRangee( 8 );
      R2 := ConstruireRangee( 8 );

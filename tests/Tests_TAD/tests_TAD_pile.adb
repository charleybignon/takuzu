...
package body tests_TAD_Pile is
 ...
 function test_P4a  return Boolean is
  ...
  -------------------------------------------
   ...
   function test_exception_Pile_Videc  return Boolean is
      p : Type_Pile;
      i : Integer;
   begin
      p := construirePile;
   ...
   exception
      ...
      when others =>
        return False;
   end test_exception_Pile_Videc;

   function test_Exception_Indice_Invalide return Boolean is
      p : Type_Pile;
      i : Integer;
   begin
      p := construirePile;
      ...
      return False;
   exception
      when INDICE_INVALIDE =>
        return True;
      when others =>
         return False;
   end test_Exception_Indice_Invalide;

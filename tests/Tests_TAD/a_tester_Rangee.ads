...
package A_Tester_Rangee is
  ...
  function Test_Rangee_P23b return Boolean; --26
   ...
   function Test_Rangee_P27 return Boolean; -- 44
   function Test_Rangee_P28 return Boolean; -- 45
   function Test_Rangee_P29 return Boolean; -- 46
   function Test_Rangee_P30 return Boolean; -- 47
   ...
   -- tests TAD Rangee
     ...
     (Test_Rangee_P27'Access,
       To_Unbounded_String ("echec de la propriete 27 Rangee")),
     (Test_Rangee_P28'Access,
       To_Unbounded_String ("echec de la propriete 28 Rangee")),
     (Test_Rangee_P29'Access,
       To_Unbounded_String ("echec de la propriete 29 Rangee")),
     (Test_Rangee_P30'Access,
       To_Unbounded_String ("echec de la propriete 30 Rangee"))
        );
